...
void COMPRESSOR_process(void) {
    ...
    if ((compressor_ctx.state == COMPRESSOR_STATE_OFF) || (compressor_ctx.state == COMPRESSOR_STATE_AUTO_OFF)) {
        ...
        if ((MANOMETER_is_pressure_increasing(scu_ctx.manometer_re)) || (MANOMETER_is_pressure_increasing(scu_ctx.manometer_cg)) || (MANOMETER_is_pressure_increasing(scu_ctx.manometer_cf1)) || (MANOMETER_is_pressure_increasing(scu_ctx.manometer_cf2))) {
