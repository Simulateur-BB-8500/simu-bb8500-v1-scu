...
void MANOMETER_manage_power(void) {
    // Check all manometer.
    if ((manometer_cp.flag_is_moving == 0) && (manometer_re.flag_is_moving == 0) && (manometer_cg.flag_is_moving == 0) && (manometer_cf1.flag_is_moving == 0) && (manometer_cf2.flag_is_moving == 0)) {
        // Turn manometer off.
