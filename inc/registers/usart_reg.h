...
#define USART1	((USART_base_address_t*) ((unsigned int) 0x40011000))
#define USART2	((USART_base_address_t*) ((unsigned int) 0x40004400))
#define USART3	((USART_base_address_t*) ((unsigned int) 0x40004800))
#define UART4	((USART_base_address_t*) ((unsigned int) 0x40004C00))
#define UART5	((USART_base_address_t*) ((unsigned int) 0x40005000))
#define USART6	((USART_base_address_t*) ((unsigned int) 0x40011400))
#define UART7	((USART_base_address_t*) ((unsigned int) 0x40007800))
#define UART8	((USART_base_address_t*) ((unsigned int) 0x40007C00))
