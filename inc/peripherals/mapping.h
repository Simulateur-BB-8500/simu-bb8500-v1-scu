...
// S.
static const GPIO GPIO_S =					(GPIO) {GPIOA, 0, 7, 0}; 	// ADC1_IN7.
// PBL2.
...
static const GPIO GPIO_MP_TP =				(GPIO) {GPIOD, 3, 1, 0};
static const GPIO GPIO_MP_TM =				(GPIO) {GPIOD, 3, 2, 0};
static const GPIO GPIO_MP_PR =				(GPIO) {GPIOD, 3, 3, 0};
static const GPIO GPIO_MP_P =				(GPIO) {GPIOD, 3, 4, 0};
static const GPIO GPIO_MP_FP =				(GPIO) {GPIOD, 3, 5, 0};
static const GPIO GPIO_MP_FM =				(GPIO) {GPIOD, 3, 6, 0};
static const GPIO GPIO_MP_FR =				(GPIO) {GPIOD, 3, 7, 0};
static const GPIO GPIO_MP_TR =				(GPIO) {GPIOD, 3, 8, 0};
static const GPIO GPIO_MP_VA =				(GPIO) {GPIOD, 3, 9, 0};
// VACMA.
static const GPIO GPIO_VACMA_R =			(GPIO) {GPIOD, 3, 10, 0};
static const GPIO GPIO_VACMA_M =			(GPIO) {GPIOD, 3, 11, 0};
// DEP.
static const GPIO GPIO_DEP =				(GPIO) {GPIOC, 2, 2, 0};
// Motor amperemeters.
...
// Manometers.
static const GPIO GPIO_ZMANOS =				(GPIO) {GPIOE, 4, 5, 0};
